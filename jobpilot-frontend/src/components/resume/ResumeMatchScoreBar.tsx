...
const ResumeMatchScoreBar = ({ score }: { score: number }) => {
  ...
  return (
  <div className="mb-8 p-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700">
    <div className="flex items-center justify-between mb-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-slate-600 dark:text-slate-400">{getScoreText(score)}</span>
      </div>
    </div>
