    ...
    >
      ...
      {!expanded && (
        <div className={`
          ...
          bg-gray-900 text-white dark:bg-gray-800 dark:text-gray-100 whitespace-nowrap shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-200 z-50
        `}>
          {text}
          <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-2 border-4 border-transparent border-r-gray-900 dark:border-r-gray-800"></div>
        </div>
      )}
    </a>
  </li>
